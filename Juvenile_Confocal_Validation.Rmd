...
ThickConfocal_plot<-ggplot(Thick1, aes(x=Nutrition, y=mean, fill=Nutrition)) + 
  ...
  geom_text(x=1.5, y=800, label="p<0.01", size=6, color="black") + 
  theme_classic()+
  ylim(0,800)+
...
ThickCorr<-ggplot(compareThick, aes(x=Thickness, y=Zstack, color=Nutrition)) + 
  ...
  theme_classic()+
  theme(text = element_text(size = 18))+
  geom_text(x=650, y=350, label="r=0.58, p<0.01", size=6, color="black") +
  theme(axis.text = element_text(size = 18, color="black"))+
  theme(axis.title = element_text(size = 18, face="bold"))+
...
RedConfocal_plot<-ggplot(Red1, aes(x=Nutrition, y=mean, fill=Nutrition)) + 
  ...
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=.2,             
                position=position_dodge(.9))+
  geom_text(x=1.5, y=44, label="p<0.01", size=6, color="black") +
  theme_classic()+
  ylim(0,45)+
  theme(text = element_text(size = 18))+
  theme(axis.text = element_text(size = 18, color="black"))+
...
Cells_plot<-ggplot(Cells1, aes(x=Nutrition, y=mean, fill=Nutrition)) + 
  ...
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=.2,             
                position=position_dodge(.9))+
  geom_text(x=1.5, y=3200000, label="p=0.04", size=6, color="black") +
  theme_classic()+
  ylim(0,3200000)+
  theme(text = element_text(size = 18))+
  theme(axis.text = element_text(size = 18, color="black"))+
...
RedCorr<-ggplot(compareRed, aes(x=Density, y=Red, color=Nutrition)) + 
  ...
  theme_classic()+
  theme(text = element_text(size = 18))+
  geom_text(x=3500000, y=22, label="r=0.43, p=0.045", size=6, color="black") +
  theme(axis.text = element_text(size = 18, color="black"))+
  theme(axis.title = element_text(size = 18, face="bold"))+
  theme(legend.title = element_text(size = 18, face="bold"))+
  theme(legend.text = element_text(size = 18, color="black"))+
