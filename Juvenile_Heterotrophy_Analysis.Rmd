...
stress.effectsFINAL<-plot(eff.stressFINAL,
                   ...
                   lattice=list(key.args=list(space="top",
                                              ...
                                              cex=1.5,
                                              cex.title=1.5,
                                              title=expression(bold("Pre-Stress Temperature - Nutrition")))));stress.effectsFINAL
...
ggsave(filename="Figures/stress_fig_end.png", plot=stress_figs_end, dpi=300, width=10, height=10, units="in")
```
