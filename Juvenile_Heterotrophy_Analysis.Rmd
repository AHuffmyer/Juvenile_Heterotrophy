---
title: Juvenile P. acuta coral nutritional and thermal regime enhance thermal tolerance through physiological preparation
...
```{r, results=FALSE}
confocalfig1<-plot_grid(Thick2, Red2, Cor1, labels = c("A", "B", "C"), ncol=3, nrow=1, rel_heights= c(1,1,1), rel_widths = c(1,1,1.25), label_size = 20, label_y=1, align="h")
