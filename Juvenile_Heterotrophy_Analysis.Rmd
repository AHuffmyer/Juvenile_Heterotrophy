...
ggsave(filename="Figures/survival_figure.png", plot=survplotsALL, dpi=300, width=13, height=8, units="in")
...
ggsave(filename="Figures/confocalfinal.png", plot=confocalfinal, dpi=300, width=10, height=6, units="in")
```
...
stress.effects2<-plot(eff.stress2,
                   ...
                   lattice=list(key.args=list(space="right",
                                              ...
                                              cex=1.5,
                                              cex.title=1.5,
                                              title=expression(bold("Treatments")))));stress.effects2
```
...
ggsave(filename="Figures/stress_fig_end.png", plot=stress_figs_end, dpi=300, width=7, height=10, units="in")
```
