...
Generate final figure of response variables. Do not include PCA as it does not add more information than univariate responses.      
```{r, results=FALSE}
confocalfig1<-plot_grid(Thick3, Red3, labels = c("A", "B"), ncol=2, nrow=1, rel_heights= c(1,1), rel_widths = c(1,1.25), label_size = 20, label_y=1, align="h")
